...
class PaymentTransaction {
  ...
  final String? receiptNo; // Makbuz/fiş/dekont numarası
  ...
  /// Map objesinden PaymentTransaction nesnesine dönüştürür.
  ...
  @override
  String toString() {
    return 'PaymentTransaction(id: $id, paymentId: $paymentId, amount: $amount, date: $date, method: $method)';
  }
}
